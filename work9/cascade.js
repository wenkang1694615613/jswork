...
majorSelect.onchange = function () {
    classSelect.options.length=0;
    optionKinds(classSelect, classSelectArr[collegeSelect.value][majorSelect.value]);
};